            ...
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="login" method="post">
                    ...
                    <div class="form-group m-t-40">
                        <div class="col-xs-12">
                        	<s:textfield id="usuario" name="usuario" cssClass="form-control" placeholder="ID Usuario" required="true" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                        	<s:password id="clave" name="clave" cssClass="form-control" placeholder="Contraseña" required="true" />
                        </div>
                    </div>
